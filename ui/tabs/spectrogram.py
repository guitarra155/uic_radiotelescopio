...
def build_spectrogram(page: ft.Page, key_state: dict) -> ft.Control:
    img = ft.Image(src=chart_spectrogram(), fit=ft.BoxFit.CONTAIN, border_radius=10, expand=True, gapless_playback=True)
    ...
    async def on_refresh(msg):
        if msg == "refresh_charts":
            ...
            if engine_instance.active_tab != 1: return # Solo renderizar si es la pestaña activa
    ...
    main_container.content = ft.Column([
        ft.Container(content=ft.GestureDetector(
            ...
            drag_interval=0,
            content=img), expand=True, bgcolor=PANEL_BG,
